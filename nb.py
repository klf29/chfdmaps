...
def validate_user(usrobj):
    ...
    user = usrobj
    logging.info("user validation routine ....")
...
class MainPage(webapp2.RequestHandler):
    ...
    def get(self):
        ...
        """logging.info("Mainpage, validated caller refers to a " + type(caller).__name__)"""
        if caller is None:
            self.redirect(users.create_login_url('/'))
        else:
            logging.info("Mainpage visited by user with email address:" +  caller )
...
class Recent(webapp2.RequestHandler):
    ...
    def get(self):
        ...
        if caller is None:
            self.redirect(users.create_login_url('/'))
        logging.info("Page /recent visited by user with email address:" +  caller )
...
class LogSenderHandler(InboundMailHandler):
    ...
    def receive(self, mail_message):
        ...
        valid_senders = [ 'cayugaheightsfire@tompkins-co.org','cayuga.heights.fd@gmail.com','meanredfink@gmail.com','friedman430@gmail.com','ken.friedman@cornell.edu','klf29@cornell.edu' ]
